...
class product_details6 extends StatelessWidget{
 ...
 const product_details6({super.key});
   @override 
        ...
        child: SafeArea(
          ...
          child: Padding(padding: EdgeInsets.only(top: 30,bottom: 20),
               ...
               children: [
                ...
                SizedBox(height: 30),
                Center(
                  child: Image.asset("assets/mix rice.jpg",
                ...
                Padding(
                  ...
                  SizedBox(height: 20,),
                 Text("Mix rice are healthier than regular burgers." 
