...
class product_details8 extends StatelessWidget{
 ...
 const product_details8({super.key});
   @override 
        ...
        child: SafeArea(
          ...
          child: Padding(padding: EdgeInsets.only(top: 30,bottom: 20),
               ...
               children: [
                ...
                SizedBox(height: 30),
                Center(
                  child: Image.asset("assets/sini sumble bun.jpg",
                ...
                Padding(
                  ...
                  SizedBox(height: 20,),
                 Text("Sini Sumble are healthier than regular burgers." 
