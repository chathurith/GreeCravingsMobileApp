...
class product_details3 extends StatelessWidget{
 ...
 const product_details3({super.key});
   @override 
        ...
        child: SafeArea(
          ...
          child: Padding(padding: EdgeInsets.only(top: 30,bottom: 20),
               ...
               children: [
                ...
                SizedBox(height: 50),
                Center(
                  child: Image.asset("assets/Fride rice.jpg",
                ...
                Padding(
                  ...
                  SizedBox(height: 20,),
                 Text("Fried rice is a dish of cooked rice that has been stir-fried in a wok or a frying pan . " 
