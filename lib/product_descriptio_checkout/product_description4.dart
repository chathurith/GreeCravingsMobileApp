...
class product_details4 extends StatelessWidget{
 ...
 const product_details4({super.key});
   @override 
        ...
        child: SafeArea(
          ...
          child: Padding(padding: EdgeInsets.only(top: 30,bottom: 20),
               ...
               children: [
                ...
                SizedBox(height: 30),
                Center(
                  child: Image.asset("assets/String hoppers.jpg",
                ...
                Padding(
                  ...
                  SizedBox(height: 20,),
                 Text("String Hoppers  are healthier than regular things." 
