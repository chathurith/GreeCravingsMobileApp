...
class product_details5 extends StatelessWidget{
 ...
 const product_details5({super.key});
   @override 
        ...
        child: SafeArea(
          ...
          child: Padding(padding: EdgeInsets.only(top: 30,bottom: 20),
               ...
               children: [
                ...
                SizedBox(height: 30),
                Center(
                  child: Image.asset("assets/macaroni.jpg",
                ...
                Padding(
                  ...
                  SizedBox(height: 20,),
                 Text("Mackaroni are healthier than regular burgers." 
