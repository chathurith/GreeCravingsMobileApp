...
class product_details7 extends StatelessWidget{
 ...
 const product_details7({super.key});
   @override 
        ...
        child: SafeArea(
          ...
          child: Padding(padding: EdgeInsets.only(top: 30,bottom: 20),
               ...
               children: [
                ...
                SizedBox(height: 50),
                Center(
                  child: Image.asset("assets/sossage bun.jpg",
                ...
                Padding(
                  ...
                  SizedBox(height: 20,),
                 Text("Sossage Bun are healthier than regular burgers." 
